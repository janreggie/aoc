	...
	testCases := []structs.TestCase{
		{Details: "Y2019D07 my input",
			Input: "3,8,1001,8,10,8,105,1,0,0,21,42,67,84,109,122,203,284,365,446," +
				...
				"9,99,3,9,1001,9,5,9,1002,9,3,9,1001,9,4,9,102,3,9,9," +
				"101,3,9,9,4,9,99,3,9,101,5,9,9,1002,9,3,9,101,5,9," +
				"9,4,9,99,3,9,102,5,9,9,101,5,9,9,102,3,9,9,101,3," +
				"9,9,102,2,9,9,4,9,99,3,9,101,2,9,9,1002,9,3,9,4," +
				"9,99,3,9,101,2,9,9,4,9,3,9,101,1,9,9,4,9,3,9," +
				"101,1,9,9,4,9,3,9,1001,9,1,9,4,9,3,9,101,1,9,9," +
				"4,9,3,9,1002,9,2,9,4,9,3,9,1002,9,2,9,4,9,3,9," +
				"1001,9,2,9,4,9,3,9,101,1,9,9,4,9,3,9,1002,9,2,9," +
				"4,9,99,3,9,1001,9,1,9,4,9,3,9,101,2,9,9,4,9,3," +
				"9,102,2,9,9,4,9,3,9,101,1,9,9,4,9,3,9,102,2,9," +
				"9,4,9,3,9,1001,9,1,9,4,9,3,9,101,1,9,9,4,9,3," +
				"9,1002,9,2,9,4,9,3,9,101,2,9,9,4,9,3,9,1002,9,2," +
				"9,4,9,99,3,9,101,2,9,9,4,9,3,9,101,2,9,9,4,9," +
				"3,9,101,2,9,9,4,9,3,9,101,1,9,9,4,9,3,9,101,1," +
				"9,9,4,9,3,9,102,2,9,9,4,9,3,9,1002,9,2,9,4,9," +
				"3,9,1002,9,2,9,4,9,3,9,101,2,9,9,4,9,3,9,1001,9," +
				"1,9,4,9,99,3,9,1001,9,1,9,4,9,3,9,101,1,9,9,4," +
				"9,3,9,102,2,9,9,4,9,3,9,1002,9,2,9,4,9,3,9,1001," +
				"9,2,9,4,9,3,9,1001,9,1,9,4,9,3,9,1001,9,2,9,4," +
				"9,3,9,1002,9,2,9,4,9,3,9,1002,9,2,9,4,9,3,9,102," +
				"2,9,9,4,9,99,3,9,102,2,9,9,4,9,3,9,1002,9,2,9," +
				"4,9,3,9,101,2,9,9,4,9,3,9,101,2,9,9,4,9,3,9," +
				"101,1,9,9,4,9,3,9,1002,9,2,9,4,9,3,9,101,1,9,9," +
				"4,9,3,9,1001,9,2,9,4,9,3,9,102,2,9,9,4,9,3,9," +
				"101,1,9,9,4,9,99",
			Result1: "262086",
			Result2: ""},
	}
	for _, eachCase := range testCases {
		eachCase.Test(Day07, assert)
	}
}
