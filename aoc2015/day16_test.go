...
const day16myInput = `Sue 1: goldfish: 9, cars: 0, samoyeds: 9
...
func TestDay16(t *testing.T) {
	assert := assert.New(t)
	testCase := structs.TestCase{
		Details: "Y2015D16 my test case",
		Input:   day16myInput,
		Result1: "40",
		Result2: "241",
	}
	testCase.Test(Day16, assert)
}

func BenchmarkDay16(b *testing.B) {
	for ii := 0; ii < b.N; ii++ {
		Day16(bufio.NewScanner(strings.NewReader(day16myInput)))
	}
}
