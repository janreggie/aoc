...
const day01sampleInput = `1721
979
366
299
675
1456`
const day01myInput = `1778
1845
1813
1889
1939
...
const day02sampleInput = `1-3 a: abcde
1-3 b: cdefg
2-9 c: ccccccccc`
const day02myInput = `4-7 z: zzzfzlzzz
3-4 l: blllk
8-11 j: jjjjjjjgjjjj
6-7 l: lllhlbl
...
const day04sampleInput = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
const day05sampleInput = `FBFBBFFRLR
BFFFBBFRRR
FFFBBBFRRR
BBFFBBFRLL
`
const day05myInput = `BFBBBBFRLL
FBFBFFBRLL
BBFBBFBLRL
BFFFBBFLLR
BFFFFBBLRL
...
const day07sampleInput = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
`
const day07myInput = `posh blue bags contain 5 plaid chartreuse bags, 3 plaid lime bags.
...
const day11sampleInput = `L.LL.LL.LL
LLLLLLL.LL
L.L.L..L..
LLLL.LL.LL
L.LL.LL.LL
...
L.LLLLLL.L
L.LLLLL.LL`
const day11myInput = `LLLLLLLLLLLLLLLLLLLLLLL.LLLLLLL.L.LLLLL.LLLL.LLLLLLLLL..LLL.LLLLLLLLLLLLLL.LLLLLLLLL.LLL.LLLLLL
...
const day12sampleInput = `F10
N3
F7
R90
F11`
const day12myInput = `S1
F17
S3
F56
W5
...
const day13sampleInput = `939
7,13,x,x,59,x,31,19`
const day13myInput = `1000507
...
const day14sampleInput = `mask = XXXXXXXXXXXXXXXXXXXXXXXXXXXXX1XXXX0X
mem[8] = 11
mem[7] = 101
mem[8] = 0
`
const day14myInput = `mask = 1100X10X01001X111001X00010X00100X011
mem[24821] = 349
mem[34917] = 13006
mem[53529] = 733
mem[50289] = 245744
...
const day16sampleInput = `class: 1-3 or 5-7
row: 6-11 or 33-44
seat: 13-40 or 45-50
...
38,6,12
`
const day16myInput = `departure location: 43-237 or 251-961
...
// day18sampleInput resolves to 71, 51, 26, 437, 12240, 13632 ==> 26457 on the first part.
// On the second part, it resolves to 231, 51, 46, 1445, 669060, 23340 ==> 694173.
const day18sampleInput = `1 + 2 * 3 + 4 * 5 + 6
1 + (2 * 3) + (4 * (5 + 6))
2 * 3 + (4 * 5)
5 + (8 * 3 + 9 + 3 * 4 * 3)
5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))
...
`
const day18myInput = `9 * 2 + 3 + 9 * ((3 * 3 + 7 * 6 + 5 + 5) * 8 * (6 * 8 + 7 * 2) + 4)
...
const day19sampleInput = `42: 9 14 | 10 1
9: 14 27 | 1 26
10: 23 14 | 28 1
1: "a"
11: 42 31
...
` // from Part 2
const day19myInput = `70: 90 92 | 53 50
99: 90 102 | 53 22
24: 130 90
125: 85 53 | 100 90
61: 53 58 | 90 26
